...
Each key is tracked in keyStats:
...
Update the CSS custom properties inside :root in styles.css.
Syllable set / language feel
Edit the syllables array in script.js.
Daily goal
Modify DAILY_GOAL_MINUTES in script.js.

Roadmap / Ideas

Possible enhancements:
Multiple keyboard layouts (QWERTY / AZERTY / Colemak)
Adjustable lesson length and difficulty presets
Optional sound feedback for key errors
